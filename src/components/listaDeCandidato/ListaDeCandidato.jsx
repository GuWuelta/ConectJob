...
export default function ListaDeCandidato(){
	...
	return(
        ...
        <div style={menu}>
            ...
            <h3 style={div.h3}>Utilize os botões abaixo para filtrar o nível de candidato que você deseja</h3>

            <div style={div.botoes}>
                <div style={div.niveis}>
                    <a style={div.tamanho} href={'/estagio'} >Estágio</a>
                </div>
                <div style={div.niveis}>
                    <a style={div.tamanho} href={'/junior'} >Júnior</a>
                </div>
                <div style={div.niveis}>
                    <a style={div.tamanho} href={'/pleno'} >Pleno</a>
                </div>
                <div style={div.niveis}>
                    <a style={div.tamanho} href={'/senior'} >Sênior</a>
                </div>
            </div>
